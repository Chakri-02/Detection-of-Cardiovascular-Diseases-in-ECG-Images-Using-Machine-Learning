...
class ECG:
	...
	def DimensionalReduciton(self,test_final):
		...
		pca_loaded_model = joblib.load("D:\\project\\Deployment\\Deployment\\PCA_ECG (1).pkl")
	...
	def ModelLoad_predict(self,final_df):
		...
		"""
		loaded_model = joblib.load("D:\\project\\Deployment\\Deployment\\Heart_Disease_Prediction_using_ECG (4).pkl")
